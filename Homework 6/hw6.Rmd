...
can equivalently be express as the set of equalities:

\begin{align*}
\boldsymbol{y} - X\boldsymbol\beta &= \lambda \boldsymbol1 + \boldsymbol{e} \\
-\boldsymbol{y} + X\boldsymbol\beta &= \lambda \boldsymbol1 + \boldsymbol{e}
\end{align*}
...
\begin{align*}
\boldsymbol{e} + X\boldsymbol\beta &= \boldsymbol{y} - \lambda \boldsymbol1 \\
\boldsymbol{e} - X\boldsymbol\beta &= -\boldsymbol{y} - \lambda \boldsymbol1
\end{align*}
...
\begin{align*}
\min_{\boldsymbol\beta,\boldsymbol{e}} \norm{\boldsymbol{e}}_1 \textrm{ st. }& \boldsymbol{e} > \boldsymbol{0}\textrm{, and} \\
&\begin{bmatrix}
I & X \\
I & -X \\
\end{bmatrix}
...
The goal is to maximize returns while minimizing variance in returns.
