...
Householder reflections instead. They work by rotating the original matrix, an
operation with condition number of 1. The result is that it doesn't amplify
errors in $A$, assuming $A$ represents real data that contains noise, etc. from
measurement.
